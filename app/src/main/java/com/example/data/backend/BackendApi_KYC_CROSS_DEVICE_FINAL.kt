...
@JsonClass(generateAdapter = true)
data class AdRequest(val type: String, val cryptoAmount: Double, val fiatPrice: Double, val minOrderEtb: Double, val maxOrderEtb: Double, val paymentMethod: String, val paymentName: String, val accountNumber: String, val fiatOrderAmount: Double = cryptoAmount * fiatPrice)
@JsonClass(generateAdapter = true)
...
@JsonClass(generateAdapter = true)
data class BackendAd(val id: String, val sellerId: String, val sellerName: String, val type: String, val cryptoAmount: Double, val fiatPrice: Double, val fiatOrderAmount: Double = cryptoAmount * fiatPrice, val fiatCurrency: String, val paymentMethod: String, val paymentName: String, val accountNumber: String, val isActive: Int, val minOrderEtb: Double, val maxOrderEtb: Double, val originalMaxOrderEtb: Double, val createdAt: Long)
...
interface BackendApi {
    ...
    @GET("v1/kyc/me") suspend fun myKyc(@Header("Authorization") auth: String): Response<KycResponse>
    @GET("v1/admin/kyc/pending") suspend fun adminKycs(@Header("Authorization") auth: String): Response<AdminKycResponse>
