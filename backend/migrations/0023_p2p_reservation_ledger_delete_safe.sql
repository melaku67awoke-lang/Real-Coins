...
-- prevents deletion of the ad it records.

PRAGMA foreign_keys=OFF;

-- Remove triggers that reference the ledger before rebuilding the table.

DROP TRIGGER IF EXISTS trg_p2p_ad_reservation_insert_ledger;
DROP TRIGGER IF EXISTS trg_p2p_ad_reservation_delete_ledger;
DROP TRIGGER IF EXISTS trg_p2p_ad_reservation_consume_on_completion;
...
ALTER TABLE p2p_ad_reservation_ledger_v3
