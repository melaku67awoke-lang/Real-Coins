...
SELECT id, ad_id, account_id, NULL, event, real_delta, locked_delta, created_at_ms
FROM p2p_ad_reservation_ledger;

DROP TABLE p2p_ad_reservation_ledger;
ALTER TABLE p2p_ad_reservation_ledger_v2 RENAME TO p2p_ad_reservation_ledger;
